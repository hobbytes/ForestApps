...
function php_file_tree_dir($directory, $return_link, $extensions = array(), $first_call = true) {
	...
	foreach($file as $this_file) {
		if( is_dir("$directory/$this_file" ) ){
			if(eregi('system/users/',"$directory/$this_file") || eregi('system/core',"$directory/$this_file")){
				if($_SESSION['superuser'] != $_SESSION['loginuser'] && !eregi('system/users/'.$_SESSION['loginuser'],"$directory/$this_file") || $_SESSION['superuser'] != $_SESSION['loginuser'] && eregi('system/core',"$directory/$this_file")){
			}else{
				$dirs[] = $this_file;
			}
		}else{
